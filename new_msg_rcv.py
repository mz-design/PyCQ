...
def receive_and_play_new_message(caller_ip, asset):
    ...
    if asset.endswith(constants.AUDIO_TYPE):    # we deal with audio message - get message file from 'Caller' http
        ...
        custom_popup.show_custom_popup("New voice message", 'message-icon.png',f'{constants.MESSAGE_STORE}/{asset}')
        # audio.voice_play(f'{constants.MESSAGE_STORE}/{asset}')

    elif asset is 'text':
        pass
        # text message
    elif asset is 'fire_alert':
        pass
        # fire_alert
    elif asset is 'earthquake_alert':
        pass
        # earthquake alert
    elif asset is 'tsunami_alert':
        pass
        # tsunami alert
    elif asset is 'intruder_alert':
        pass
        # intruder alert
    elif asset is 'missile_alert':
        pass
        # missile alert
    else:
